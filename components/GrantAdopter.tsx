                         ...
                         <div className="animate-fade-in space-y-6">
                            <div className="flex justify-between items-start">
                                <div className="w-2/3 space-y-3">
                                    <SkeletonLoader type="title" className="h-6 w-3/4" />
                                    <SkeletonLoader type="text" className="w-1/2" />
                                    <SkeletonLoader type="text" className="w-1/3" />
                                </div>
                                <div className="flex space-x-2">
                                    <SkeletonLoader type="badge" className="w-8 h-8 rounded" />
                                    <SkeletonLoader type="badge" className="w-8 h-8 rounded" />
                                </div>
                            </div>
                            <div className="border-t border-slate-700/50 pt-6 space-y-4">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div className="space-y-2"><SkeletonLoader type="text" className="w-1/3" /><SkeletonLoader type="text" className="w-2/3" /></div>
                                    <div className="space-y-2"><SkeletonLoader type="text" className="w-1/3" /><SkeletonLoader type="text" className="w-2/3" /></div>
                                    <div className="space-y-2"><SkeletonLoader type="text" className="w-1/3" /><SkeletonLoader type="text" className="w-2/3" /></div>
                                    <div className="space-y-2"><SkeletonLoader type="text" className="w-1/3" /><SkeletonLoader type="text" className="w-2/3" /></div>
                                </div>
